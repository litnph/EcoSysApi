    ...
    public partial class InitialSqlServer : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_audit_log_retention", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    necessity_level = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    created_at = table.Column<DateTime>(type: "datetime2", nullable: false),
                    updated_at = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    reconciliation_note = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    issuer_statement_amount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    created_at = table.Column<DateTime>(type: "datetime2", nullable: false),
                    updated_at = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    alert_key = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    was_notified = table.Column<bool>(type: "bit", nullable: false),
                    created_at = table.Column<DateTime>(type: "datetime2", nullable: false),
                    updated_at = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_fin_budget_alert_states", x => x.id);
                    table.ForeignKey(
                        name: "fk_fin_budget_alert_states_fin_categories_category_id",
                        column: x => x.category_id,
                        principalTable: "fin_categories",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_fin_budget_alert_states_users_user_id",
                        column: x => x.user_id,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    target_mode = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    is_enabled = table.Column<bool>(type: "bit", nullable: false),
                    warning_thresholds_json = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    configuration_version = table.Column<int>(type: "int", nullable: false),
                    created_at = table.Column<DateTime>(type: "datetime2", nullable: false),
                    updated_at = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_fin_category_budgets", x => x.id);
                    table.ForeignKey(
                        name: "fk_fin_category_budgets_fin_categories_category_id",
                        column: x => x.category_id,
                        principalTable: "fin_categories",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_fin_category_budgets_users_user_id",
                        column: x => x.user_id,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    report_currency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: true),
                    has_consolidated_totals = table.Column<bool>(type: "bit", nullable: false),
                    status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    closed_at = table.Column<DateTime>(type: "datetime2", nullable: true),
                    closed_by = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    category_breakdown = table.Column<string>(type: "text", nullable: true),
                    source_breakdown = table.Column<string>(type: "text", nullable: true),
                    report_created_at = table.Column<DateTime>(type: "datetime2", nullable: true),
                    last_refreshed_at = table.Column<DateTime>(type: "datetime2", nullable: true),
                    report_snapshot = table.Column<string>(type: "text", nullable: true),
                    created_at = table.Column<DateTime>(type: "datetime2", nullable: false),
                    updated_at = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    spent_amount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    budget_amount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    utilization_percent = table.Column<decimal>(type: "decimal(9,2)", precision: 9, scale: 2, nullable: true),
                    threshold_percent = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
                    cycle_start = table.Column<DateOnly>(type: "date", nullable: true),
                    cycle_end = table.Column<DateOnly>(type: "date", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_user_notifications_fin_categories_category_id",
                        column: x => x.category_id,
                        principalTable: "fin_categories",
                        principalColumn: "id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    monthly_report_day = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_user_profiles_monthly_report_day", "monthly_report_day >= 1 AND monthly_report_day <= 31");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    start_date = table.Column<DateOnly>(type: "date", nullable: false),
                    schedule_version = table.Column<int>(type: "int", nullable: false),
                    status = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    saving_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    billing_cycle_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    client_request_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "ix_audit_log_retention_entity_type",
                table: "audit_log_retention",
                column: "entity_type",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "ix_fin_budget_alert_states_category_id",
                table: "fin_budget_alert_states",
                column: "category_id");

            migrationBuilder.CreateIndex(
                name: "ix_fin_budget_alert_states_user_id_category_id_currency_cycle_start_cycle_end_configuration_version_alert_key",
                table: "fin_budget_alert_states",
                columns: new[] { "user_id", "category_id", "currency", "cycle_start", "cycle_end", "configuration_version", "alert_key" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_fin_categories_code",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_fin_category_budgets_category_id",
                table: "fin_category_budgets",
                column: "category_id");

            migrationBuilder.CreateIndex(
                name: "ix_fin_category_budgets_user_id_category_id",
                table: "fin_category_budgets",
                columns: new[] { "user_id", "category_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_fin_category_budgets_user_id_is_enabled",
                table: "fin_category_budgets",
                columns: new[] { "user_id", "is_enabled" });

            migrationBuilder.CreateIndex(
                name: "ix_fin_debt_record_history_entity_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_fin_installment_plan_history_entity_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_fin_monthly_periods_year_month",
                table: "fin_monthly_periods",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_fin_source_history_entity_id",
                table: "fin_source_history",
                column: "entity_id");

            migrationBuilder.CreateIndex(
                name: "ix_fin_transaction_history_transaction_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_user_notifications_category_id",
